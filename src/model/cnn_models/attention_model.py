...
def transformer_model():
    ...
    # Process vth input similarly
    y = Conv1D(64, 2, activation='relu')(vth)
    y = Dropout(0.2)(y)
    y = Conv1D(128, 2, activation='relu')(y)
    y = Flatten()(y)
    y = Dense(64, activation='relu')(y)

    # Process cooling input
    z = Dense(32, activation='relu')(cooling)
    ...
    # Define the model
    model = Model(inputs=[input_sequence, vth, cooling], outputs=pred)
